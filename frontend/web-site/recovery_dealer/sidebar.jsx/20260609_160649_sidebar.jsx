...
const NAV_ITEMS = [
    ...
    { label: "Nhà cung cấp", icon: Store,            to: "/dai-ly/nha-cung-cap"           },
    { label: "Danh mục",     icon: LayoutGrid,       to: "/dai-ly/danh-muc"               },
                ...
                {NAV_ITEMS.map(({ label, icon: Icon, to, end }) => (
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            ...
                            ${isActive
                                ? "bg-indigo-50 border-l-4 border-indigo-800 text-indigo-700 pl-3"
