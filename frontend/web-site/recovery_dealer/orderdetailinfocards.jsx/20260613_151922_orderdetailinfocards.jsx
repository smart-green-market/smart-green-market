        ...
        <div>
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center text-sm gap-1">
              <span className="text-neutral-600 font-bold flex items-center gap-1.5 w-[105px] shrink-0 whitespace-nowrap">
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 p-6 shadow-xs flex flex-col justify-between">
        <div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center text-sm gap-1">
              <span className="text-neutral-600 font-bold flex items-center gap-1.5 w-[105px] shrink-0 whitespace-nowrap">
                <Clock className="w-3.5 h-3.5 text-amber-500" /> Thời gian giao:
              </span>
              <span className="font-bold text-neutral-800">
