    ...
    status_histories: [
      {
        status: "received",
        label: "Đã nhận đơn",
        at: "2024-05-24T08:30:00.000Z",
      },
      {
        status: "preparing",
        label: "Đang chuẩn bị hàng",
        at: "2024-05-24T09:00:00.000Z",
      },
    ],
  },
  {
    ...
    status_histories: [
      {
        status: "received",
        label: "Đã nhận đơn",
        at: "2024-05-22T14:15:00.000Z",
      },
      {
        status: "preparing",
        label: "Đang chuẩn bị hàng",
        at: "2024-05-22T15:00:00.000Z",
      },
      {
        status: "shipping",
        label: "Đang giao hàng",
        at: "2024-05-23T07:30:00.000Z",
      },
    ],
  },
  {
    ...
    status_histories: [
      {
        status: "received",
        label: "Đã nhận đơn",
        at: "2024-05-20T10:00:00.000Z",
      },
      {
        status: "preparing",
        label: "Đang chuẩn bị hàng",
        at: "2024-05-20T11:00:00.000Z",
      },
      {
        status: "shipping",
        label: "Đang giao hàng",
        at: "2024-05-21T08:00:00.000Z",
      },
      {
        status: "completed",
        label: "Giao hàng thành công",
        at: "2024-05-21T15:20:00.000Z",
      },
    ],
  },
  {
    ...
    status_histories: [
      {
        status: "received",
        label: "Đã nhận đơn",
        at: "2024-05-18T16:45:00.000Z",
      },
      {
        status: "cancelled",
        label: "Đã hủy đơn",
        at: "2024-05-18T17:10:00.000Z",
      },
    ],
  },
  {
...
export function getMockUserOrderById(id) {
  return (
    MOCK_USER_ORDERS.find((order) => String(order.id) === String(id)) ?? null
  );
}
