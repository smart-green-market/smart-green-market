...
const HIGHLIGHTS = [
    { icon: Package, label: "Quản lý sản phẩm & danh mục" },
    { icon: Users, label: "Kết nối trực tiếp tới các đại lý" },
    { icon: Bell, label: "Nhận đơn hàng & cập nhật trạng thái" },
];
    ...
    return (
        <div className="flex min-h-screen min-h-[100dvh] w-full font-['Geist',sans-serif]">
            ...
            <aside className="relative hidden overflow-hidden bg-[#064e3b] lg:flex lg:w-[46%] lg:flex-col lg:justify-between lg:p-12">
                <div
                    className="absolute inset-0 bg-cover bg-center opacity-40 supplier-login-bg"
                    style={{
                        backgroundImage:
                ...
                <div className="relative z-10 max-w-md space-y-8">
                    <div>
                        ...
                        <h1 className="font-['Noto_Serif',serif] text-[2rem] font-bold leading-tight tracking-tight text-white xl:text-[2.35rem]">
                            Cung cấp nông sản sạch trực tiếp đến Đại lý
                        </h1>
                        <p className="mt-4 text-sm leading-relaxed text-emerald-100/85">
                            Quản lý quy trình canh tác, đăng bán sản phẩm chất lượng cao và xử lý đơn đặt hàng nhanh chóng từ các đại lý.
                        </p>
                    </div>
            ...
            <main className="relative flex flex-1 flex-col items-center justify-center bg-[#f7f7f5] px-4 py-6 sm:px-8 sm:py-10">
                ...
                <div className="supplier-login-enter relative w-full max-w-[420px]">
                    {/* Header mobile */}
                        ...
                        >
                            <div className="mb-6 text-center sm:mb-8">
                                ...
                                <p className="mt-1 text-sm text-neutral-500">
                                    Tài khoản đối tác nhà cung cấp
                                </p>
                            </div>
                            ...
                            <p className="mt-4 text-center text-sm text-neutral-500">
                                Chưa có tài khoản?{" "}
                                <Link
                                    to="/dang-ky-nha-cung-cap"
                                    className="font-semibold text-emerald-800 hover:text-emerald-950 transition-colors no-underline"
                                >
            ...
            <style>{`
                ...
                @keyframes supplierLoginBg {
                    from { transform: scale(1); }
                    to { transform: scale(1.06); }
                }
                .supplier-login-enter {
                    animation: supplierLoginEnter 0.45s ease-out both;
                }
                .supplier-login-bg {
                    animation: supplierLoginBg 18s ease-in-out infinite alternate;
                }
