...
export default function ActiveOrderCard({ order, onViewDetail }) {
  return (
      ...
      <div className="p-6">
        ...
        <div className="flex justify-end">
          <button
            ...
            className="cursor-pointer rounded-lg bg-teal-800 px-6 py-2.5 text-base font-normal text-white shadow-sm transition-colors hover:bg-teal-900"
          >
            Xem chi tiết
          </button>
        </div>
