    ...
    <div className="flex-1 p-12 flex flex-col justify-between relative overflow-hidden bg-[#006c49]">
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-[#9df4c9] leading-[1.75] opacity-90 mb-7">
          Kết nối với chuỗi cung ứng nông sản bền vững. Quản lý cửa hàng,
          sản phẩm bán lẻ và theo dõi đơn hàng trong tầm tay bạn.
        </p>
        ...
        <div className="flex gap-3">
          <div className="flex-1 bg-white/15 border border-white/20 rounded-2xl p-4 backdrop-blur-md">
            ...
            <div className="text-[11px] text-white/65 mb-1">Cửa hàng</div>
            <div className="text-base font-bold text-white">Quản lý bán lẻ</div>
          </div>
          <div className="flex-1 bg-white/15 border border-white/20 rounded-2xl p-4 backdrop-blur-md">
            <div className="text-2xl mb-2">📦</div>
            <div className="text-[11px] text-white/65 mb-1">Sản phẩm</div>
            <div className="text-base font-bold text-white">Nguồn hàng sạch</div>
          </div>
        </div>
      </div>
